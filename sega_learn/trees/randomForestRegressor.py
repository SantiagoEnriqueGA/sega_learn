...
class RandomForestRegressor(object):
    ...
    def __init__(self, num_trees, max_depth):
        ...
        self.decision_trees = [RegressorTree(max_depth) for i in range(num_trees)]  # Initialize the decision trees
...
class RunRandomForestRegressor(object):
    """
    ...
    def run(self):
        ...
        randomForest = RandomForestRegressor(self.forest_size,self.max_depth)    # Initialize the random forest object
