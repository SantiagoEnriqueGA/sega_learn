...
log_reg = LogisticRegression(learning_rate=0.01, max_iter=1_000)
...
# Save the plot
plt.tight_layout()
plt.savefig("examples/linear_models/plots/logisticRegression_binary.png", dpi=300)
# plt.show()
...
# Save the plot
plt.tight_layout()
plt.savefig("examples/linear_models/plots/logisticRegression_multiclass.png", dpi=300)
# plt.show()
