...
nn1 = CuPyBackendNeuralNetwork(layers = [input_size] + layers + [output_size], activations=activations,
...
layers = [
        ...
        CuPyDenseLayer(layers[2], output_size, activation="softmax" if output_size > 2 else "sigmoid"),
]

# Initialize Neural Network
nn2 = CuPyBackendNeuralNetwork(layers=layers, dropout_rate=dropout, reg_lambda=reg_lambda)
