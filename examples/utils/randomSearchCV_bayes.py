...
# grid_search = ms.RandomSearchCV(Bayesian, grid, iter=5, cv=3, metric='r2', direction='maximize')
grid_search = ms.RandomSearchCV(Bayesian, grid, iter=5, cv=3, metric='mse', direction='minimize')
