...
print("Class distribution before Augmenter:")
...
augmenter = Augmenter([smote, ros, rus], verbose=True)

# Fit and resample the training data
X_resampled, y_resampled = augmenter.augment(X_train, y_train)

print("\nClass distribution after Augmenter:")
