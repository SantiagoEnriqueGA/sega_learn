...
sns.kdeplot(
    l1_norm_data.flatten(),
    label="L1 Norm",
    linewidth=2,
    color=colors["L1 Norm"],
    ax=axes[0],
)
...
sns.kdeplot(
    l2_norm_data.flatten(),
    label="L2 Norm",
    linewidth=2,
    color=colors["L2 Norm"],
    ax=axes[1],
)
...
sns.kdeplot(
    max_norm_data.flatten(),
    label="Max Norm",
    linewidth=2,
    color=colors["Max Norm"],
    ax=axes[2],
)
...
sns.kdeplot(
    min_max_norm_data.flatten(),
    label="Min-Max Norm",
    linewidth=2,
    color=colors["Min-Max Norm"],
    ax=axes[3],
    warn_singular=False,
)
