...
def test_ols(num_zeros, num_runs):
    ...
    for sample_size in sample_sizes:
        ...
        avg_sklearn_time, std_sklearn_time, avg_sega_time, std_sega_time = timer.measure_performance(linear_model.LinearRegression, OrdinaryLeastSquares)
    ...
    plot_results(results, "OLS Scalability")
...
def main():   
    ...
    # Run tests
    ols_num_zeros = 8
    results = test_ols(ols_num_zeros, NUM_RUNS)
    print(results)
