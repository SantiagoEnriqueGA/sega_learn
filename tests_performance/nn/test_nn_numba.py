...
def time_nn_loss_numba(
    num_repeats=5, layer_sizes_multiplier=10, dataset_size=1_000_000
):
    ...
    for name, loss_fn in loss_functions.items():
        ...
        loss_avg, loss_stddev, _ = time_function(
            loss_fn.calculate_loss, NUM_REPEATS, logits, targets
        )
