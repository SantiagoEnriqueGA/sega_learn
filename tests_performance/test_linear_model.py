...
def test_ols(X, y, X_test, NUM_SAMPLES, NUM_RUNS):
    ...
    avg_sklearn_time, avg_sega_time = timer.measure_performance(linear_model.LinearRegression, OrdinaryLeastSquares)
...
def test_ridge(X, y, X_test, NUM_SAMPLES, NUM_RUNS):
    ...
    avg_sklearn_time, avg_sega_time = timer.measure_performance(linear_model.Ridge, Ridge)
...
def test_lasso(X, y, X_test, NUM_SAMPLES, NUM_RUNS):
    ...
    timer = TestTime(X, y, X_test, reduced_sample_size, NUM_RUNS)
    avg_sklearn_time, avg_sega_time = timer.measure_performance(linear_model.Lasso, Lasso)
...
def test_bayesian(X, y, X_test, NUM_SAMPLES, NUM_RUNS):
    timer = TestTime(X, y, X_test, NUM_SAMPLES, NUM_RUNS)
    avg_sklearn_time, avg_sega_time = timer.measure_performance(linear_model.BayesianRidge, Bayesian)
...
def test_ransac(X, y, X_test, NUM_SAMPLES, NUM_RUNS):
    timer = TestTime(X, y, X_test, NUM_SAMPLES, NUM_RUNS)
    avg_sklearn_time, avg_sega_time = timer.measure_performance(linear_model.RANSACRegressor, RANSAC)
...
def test_passiveAggressiveRegressor(X, y, X_test, NUM_SAMPLES, NUM_RUNS):
    ...
    timer = TestTime(X, y, X_test, reduced_sample_size, NUM_RUNS)
    with suppress_print():
        avg_sklearn_time, avg_sega_time = timer.measure_performance(linear_model.PassiveAggressiveRegressor, PassiveAggressiveRegressor)
