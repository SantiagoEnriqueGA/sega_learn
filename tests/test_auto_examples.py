...
def load_tests(loader, tests, pattern):
    ...
    example_files = glob.glob(os.path.join(os.path.dirname(__file__), '..\\examples\\auto\\*.py'))
    ...
    for example_file in example_files:
        ...
        setattr(TestExamplesAuto, test_name, lambda self, example_file=example_file: TestExampleExceptions().test_main(example_file))
