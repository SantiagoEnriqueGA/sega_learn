...
from sega_learn.utils import make_regression, make_classification, make_blobs
...
class TestMakeData(unittest.TestCase):
    ...
    def test_make_regression_bias(self):
        ...
        X, y = make_regression(n_samples=n_samples, bias=bias, noise=0.0, 
                              random_state=self.random_state)
    ...
    def test_make_regression_noise(self):
        ...
        X_low, y_low = make_regression(n_samples=n_samples, noise=noise_low, 
                                      random_state=self.random_state)
        X_high, y_high = make_regression(n_samples=n_samples, noise=noise_high, 
                                        random_state=self.random_state)
    ...
    def test_make_regression_shuffle(self):
        ...
        X_shuffled, y_shuffled = make_regression(n_samples=n_samples, shuffle=True, 
                                               random_state=self.random_state)
        X_unshuffled, y_unshuffled = make_regression(n_samples=n_samples, shuffle=False, 
                                                    random_state=self.random_state)
        
        # Check if datasets are different
        self.assertFalse(np.array_equal(X_shuffled, X_unshuffled) and 
                          np.array_equal(y_shuffled, y_unshuffled))
    ...
    def test_make_regression_effective_rank(self):
        ...
        X, _ = make_regression(n_samples=n_samples, n_features=n_features, 
                              effective_rank=effective_rank, random_state=self.random_state)
    ...
    def test_make_classification_weights(self):
        ...
        X, y = make_classification(n_samples=n_samples, n_classes=n_classes, 
                                  weights=weights, random_state=self.random_state)
    ...
    def test_make_classification_informative_features(self):
        ...
        X, y = make_classification(n_samples=n_samples, n_features=n_features, 
                                  ...
                                  n_repeated=0, random_state=self.random_state)
        
        # Calculate feature importance using correlation with y
        correlations = np.abs(np.array([np.corrcoef(X[:, i], y)[0, 1] for i in range(n_features)]))
    ...
    def test_make_classification_redundant_features(self):
        ...
        high_corr_count = np.sum(np.abs(corr_matrix) > 0.7) - n_features  # Subtract diagonal
    ...
    def test_make_classification_repeated_features(self):
        ...
        X, _ = make_classification(n_samples=n_samples, n_features=n_features, 
                                 n_informative=n_informative, n_redundant=n_redundant,
                                 n_repeated=n_repeated, random_state=self.random_state)
        
        # Calculate correlation matrix
        corr_matrix = np.corrcoef(X, rowvar=False)
        
        # Count perfectly correlated feature pairs (correlation = 1)
        perfect_corr_count = np.sum(np.abs(corr_matrix) > 0.99) - n_features  # Subtract diagonal
        
        # Should have at least n_repeated perfect correlations
        self.assertGreaterEqual(perfect_corr_count / 2, n_repeated)  # Divide by 2 because matrix is symmetric
    ...
    def test_make_classification_flip_y(self):
        ...
        X_low_flip, y_low_flip = make_classification(n_samples=n_samples, flip_y=flip_y_low, 
    ...
    def test_make_blobs_basic(self):
        ...
        X, y, centers_out = make_blobs(n_samples=n_samples, n_features=n_features, 
                                      centers=centers, random_state=self.random_state)
    ...
    def test_make_blobs_specified_centers(self):
        ...
        X, y, centers_out = make_blobs(n_samples=n_samples, centers=centers_in, 
                                       random_state=self.random_state)
    ...
    def test_make_blobs_cluster_std(self):
        ...
        X_low_std, y_low_std, _ = make_blobs(n_samples=n_samples, centers=centers, 
                                           cluster_std=std_low, random_state=self.random_state)
        X_high_std, y_high_std, _ = make_blobs(n_samples=n_samples, centers=centers, 
                                             cluster_std=std_high, random_state=self.random_state)
    ...
    def test_make_blobs_different_stds(self):
        ...
        X, y, _ = make_blobs(n_samples=n_samples, centers=centers, 
    ...
    def test_make_blobs_n_samples_per_center(self):
        ...
        X, y, _ = make_blobs(n_samples=n_samples, n_features=n_features, 
                           random_state=self.random_state)
    ...
    def test_make_blobs_center_box(self):
        ...
        _, _, centers_small = make_blobs(n_samples=n_samples, centers=centers, 
                                       center_box=center_box_small, random_state=self.random_state)
        _, _, centers_large = make_blobs(n_samples=n_samples, centers=centers, 
                                       center_box=center_box_large, random_state=self.random_state)
    ...
    def test_make_blobs_shuffle(self):
        ...
        # Generate data with and without shuffling
        X_shuffled, y_shuffled, _ = make_blobs(n_samples=n_samples_per_center, centers=None, 
                                               shuffle=True, random_state=self.random_state)
        X_unshuffled, y_unshuffled, _ = make_blobs(n_samples=n_samples_per_center, centers=None, 
        ...
        expected_unshuffled = np.concatenate([np.full(count, i) for i, count in enumerate(n_samples_per_center)])
    ...
    def test_make_classification_invalid_params(self):
        ...
        with self.assertRaises(ValueError):
            make_classification(n_features=5, n_informative=3, n_redundant=3, n_repeated=0)
