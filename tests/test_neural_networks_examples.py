...
class TestExampleExceptions(unittest.TestCase):
    ...
    def test_main(self, example_file):
        ...
        if example_file in ['neuralNetwork_layers_conv_cifar.py', 'neuralNetwork_layers_conv.py', 'neuralNetwork_metrics_anim.py']:
            pass
...
def load_tests(loader, tests, pattern):
    ...
    for example_file in example_files:
        ...
        test_exeptions = ['neuralNetwork_hyper.py', 'neuralNetwork_classifier_hyper.py',        # Suppress prints in these example files
                          'neuralNetwork_layers_conv_cifar.py', 'neuralNetwork_layers_conv.py', # These take too long to run
