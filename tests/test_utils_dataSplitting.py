...
class TestTrainTestSplit(unittest.TestCase):
    ...
    def test_stratification(self):
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            self.X_small, self.y_small, test_size=0.5, stratify=self.y_small, random_state=random_state
        )
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            self.X, self.stratify_y, test_size=0.3, stratify=self.stratify_y, random_state=random_state
        )
